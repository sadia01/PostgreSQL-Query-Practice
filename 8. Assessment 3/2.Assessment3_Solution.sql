...
/*1. The students table should have columns for student_id, first_name,last_name,
...
/*2. The teachers table should have columns for teacher_id, first_name, last_name,
...
/*3. insert a student named Mark Watney (student_id=1) 
...
/*4. Then insert a teacher names Jonas Salk (teacher_id = 1) 
