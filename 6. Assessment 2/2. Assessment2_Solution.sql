/* 1. How can you retrieve all the information 
from the cd.facilities table? */

SELECT * FROM cd.facilities;

/* 2. You want to print out a list of all of the facilities
...
/* 4.How can you produce a list of facilities 
that charge a fee to members,
...
/* 10. Produce a count of the number of facilities that 
have a cost to guests of10 or more. */
...
output table consisting of facility id and total slots, 
